...
![Osztálydiagram](https://git.iit.bme.hu/prog2/ell_feladat/CppBolt/raw/master/cppbolt.png)
...
[dokumentációját is.](https://git.iit.bme.hu/prog2/ell_feladat/CppBolt/blob/master/doxygen/rtf/refman_mod.pdf)
Nem minden osztályt és funkciót valósítottunk meg hiánytalanul. Ennek pótlása az Ön feladata.

**Feladatok:**

1. Töltse le az előkészített projektet a Git tárolóból! [https://git.iit.bme.hu/prog2/ell_feladat/CppBolt](https://git.iit.bme.hu/prog2/ell_feladat/CppBolt)
